...
declare const Gallery: <T extends SizeType>({ items, itemRenderer, keyExtractor, gap, heightRange, itemRatioRange, maxColumns, preserveAspectRatio, scrollRef, }: GalleryProps<T>) => import("react/jsx-runtime").JSX.Element;
